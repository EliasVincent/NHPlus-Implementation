...
public class PatientDaoTest {
     ...
     * Wenn die Spalte nicht existiert, wird der Test bestanden.
     * Wenn die Spalte existiert, wird der Test nicht bestanden.
     */
    @Test
    public void testIfColumnExistsInPatientTable() {
        ...
        try {
            ...
            if (columnExists) {
                assertFalse(true, "Die Spalte existiert in der 'patient' Tabelle.");
            } else {
                assertTrue(true,"Die Spalte existiert nicht in der 'patient' Tabelle");
            }
