...
public class PatientDao extends DaoImp<Patient> {
    ...
    protected PreparedStatement getCreateStatement(Patient patient) {
        ...
        try {
            final String SQL = "INSERT INTO patient (firstname, surname, dateOfBirth, carelevel, roomnumber, locked, datecreated) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            preparedStatement.setBoolean(6, patient.isLocked());
            preparedStatement.setString(7, patient.getDateCreated());
